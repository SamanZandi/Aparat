...
class SpecialAdapter(mContext:Context, videol: List<Video>):
    RecyclerView.Adapter<SpecialAdapter.SpecialVH>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SpecialVH {
        val view:View= LayoutInflater.from(context).inflate(R.layout.special_row,null)
